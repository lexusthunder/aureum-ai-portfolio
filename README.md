...
| 04 | [crop-recommendation-gradio](./04_Classic_ML/crop-recommendation-gradio) | scikit-learn · Gradio · real dataset | RandomForest + Gradio web UI on 22-class crop dataset |
